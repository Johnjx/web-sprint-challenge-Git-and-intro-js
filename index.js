...
function removeArtist(array, indexNumber) {
  const modifiedArtists = [...array];
  modifiedArtists.splice(indexNumber, 1);
...
console.log('Task 6:', addArtist(artists, "John R", "1995 - 2022", "Full Stack Dev", "Canadian", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Pretium aenean pharetra magna ac placerat vestibulum lectus mauris ultrices. Posuere lorem ipsum dolor sit amet consectetur adipiscing elit duis."));
...
function lotsOfArt(array) {
  const manyWorkArtists = [];
  for (let i = 0; i < array.length; i++) {
    if (array[i].paintings > 100) {
      manyWorkArtists.push(array[i].name);
    }
  }
    return manyWorkArtists;
}
...
function artistInfo(array, nameToFind){
  for (let i = 0; i < array.length; i++) {
